  ...
  return (
    <section className="py-12 md:py-16 bg-yellow-400">
      ...
      >
        ...
        <p className="text-black-600">Certified, professional, and customer-first</p>
      </motion.div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-9">
        ...
        return (
          ...
          viewport={{ once: true }}
          whileHover={{ y: -5 }}
          className="text-center p-4 rounded-lg bg-white shadow-md hover:shadow-xl transition-all border border-yellow-400"
          >
          <Icon className={`${badge.color} mx-auto mb-2`} size={28} />
          <p className=" font-semibold mb-1 text-black">{badge.title}</p>
